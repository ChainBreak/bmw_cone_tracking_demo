...
class ConeDetector():
    def __init__(self):
        ...
        #1D gaussian filter to smooth out vertical pixel sums
        self.f_smooth = cv2.getGaussianKernel(51,51.0).reshape(-1)
    ...
    def detect_color_object(self):
        ...
        hist_smooth = np.convolve(self.f_smooth,hist_y,mode="same")
